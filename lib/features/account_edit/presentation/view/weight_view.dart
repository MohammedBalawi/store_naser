      ...
      appBar:AppBar(
        ...
        title:Row(
          ...
          children: [
            ...
            Text(ManagerStrings.yourWeight, style: getBoldTextStyle(color: Colors.black, fontSize: 20)),
          ...
          children: [
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                      ManagerStrings.addWeight, style: getBoldTextStyle(color: Colors.black, fontSize: 14)),
