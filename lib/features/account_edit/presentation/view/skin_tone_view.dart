      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            ...
            Text(ManagerStrings.skinColor, style: getBoldTextStyle(color: Colors.black, fontSize: 20)),
                ...
                children: [
                  Obx(() {
                    ...
                    return RichText(
                      text: TextSpan(
                        children: [
                          TextSpan(text: '${ManagerStrings.color} : ', style: getRegularTextStyle(color: Colors.black, fontSize: 16)),
