// lib/features/addressess/presentation/view/add_address_view.dart
...
class AddAddressView extends GetView<AddAddressController> {
  ...
  // دبوس + InfoWindow يظهر فوقه النص
  ...
  // يحدّث مكان الدبوس ويعرض البالون فوقه
  Future<void> _setPin(LatLng p, {double? zoom}) async {
    ...
    // إظهار الـ InfoWindow فورًا
    await _gMap?.showMarkerInfoWindow(const MarkerId('pin'));
  }

  Future<void> _goToMyLocation() async {
    await controller.onMyLocationTap(); // يحدّث lat/lng و topAddress
