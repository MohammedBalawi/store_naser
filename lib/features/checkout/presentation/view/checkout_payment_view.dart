...
import '../widgets/payment_logos_row.dart';
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 6),
                Text(
                  "${ManagerStrings.quantity}: ${c.productQty}",
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(a.name,
              style:
                  getBoldTextStyle(color: ManagerColors.black, fontSize: 12)),
          const SizedBox(height: 6),
          Text(a.addressLine,
              textAlign: TextAlign.right,
              style:
                  getMediumTextStyle(color: ManagerColors.black, fontSize: 12)),
          const SizedBox(height: 6),
          Text(a.phone,
              style:
                  getMediumTextStyle(color: ManagerColors.black, fontSize: 12)),
          ...
          Align(
            ...
            child: Text(ManagerStrings.editTitle,
                style:
                    getBoldTextStyle(color: ManagerColors.color, fontSize: 12)),
          ),
        ],
      ),
    );
...
class _PlainBlock extends StatelessWidget {
  ...
  _PlainBlock({required this.text});
  ...
  Widget build(BuildContext context) => Container(
        ...
        child: Align(
          ...
          child: Text(text,
              style:
                  getBoldTextStyle(fontSize: 12, color: ManagerColors.black)),
        ),
      );
}
...
class _PaymentMethodsCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle titleStyle =
        getBoldTextStyle(color: ManagerColors.black, fontSize: 10);
    TextStyle subStyle =
        getMediumTextStyle(color: ManagerColors.gray_3, fontSize: 12);
              ...
              children: [
                ...
                ConstrainedBox(
                  ...
                  child: const FittedBox(
                    ...
                    child:
                        PaymentLogosRow(codes: ["AMEX", "MADA", "VISA", "MC"]),
                  ),
                ),
              ],
            ),
              ...
              child: TextButton.icon(
                ...
                label: Text(ManagerStrings.addNewCard,
                    style: getMediumTextStyle(
                        color: ManagerColors.color, fontSize: 12)),
...
class _MethodRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final titleStyle =
        getBoldTextStyle(color: ManagerColors.black, fontSize: 12);
    final subStyle =
        getRegularTextStyle(color: ManagerColors.gray, fontSize: 10);
...
class _Text extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final c = Get.find<CheckoutController>();
    Text _lbl(String t) =>
        Text(t, style: getMediumTextStyle(color: Colors.black, fontSize: 12));
    Text _val(String t) =>
        Text(t, style: getMediumTextStyle(color: Colors.black, fontSize: 12));
    return Text(ManagerStrings.ifQitafIsSelected,
        style: getMediumTextStyle(fontSize: 12, color: ManagerColors.gray_1));
  }
}
      ...
      child: Column(
        children: [
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            _lbl(ManagerStrings.subTotal),
            _val("ر.س ${c.itemsSubtotal.toStringAsFixed(2)}")
          ]),
          const SizedBox(height: 8),
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            _lbl(ManagerStrings.shippingFee),
            _val("ر.س ${c.shipping.toStringAsFixed(2)}")
          ]),
          const SizedBox(height: 8),
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            _lbl(ManagerStrings.totalWithTax),
            _val("ر.س ${c.grandTotal.toStringAsFixed(2)}")
          ]),
          const SizedBox(height: 8),
        ],
      ),
